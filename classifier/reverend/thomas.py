...
class Bayes(object):
    ...
    def save(self, fname='bayesdata'):
        from pickle import load
        self.pools=cPickle.load(open(os.path.join(os.path.dirname(__file__), "my_bayes_classifier.pickle"), 'rb'))
        set('bayesdata', self.pools)
        #memcache.set(fname, self.pools)

    def load(self, fname='bayesdata'):
        self.pools = get(fname)        
